...
export const journeys: Journey[] = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        status: 'needs-call',
        note: 'The form asks for an email without promising a cadence. I didn’t invent one — say how often the build notes actually go out and I’ll put that sentence on the form.',
        metric: 'subscribes per 100 readers',
      },
    ],
    priorityMove: 'The mid-read leak is closed: an inline card at the point of peak interest, plus a related-posts block so "what’s next" has an answer. The one thing left is yours to answer, not mine to guess: what’s the actual send cadence?',
    verifiedAgainst: 'app/blog/[slug]/page.tsx, app/blog/layout.tsx, components/subscribe-form.tsx, lib/blog.ts (2026-09-14)',
  },
  {
    number: '02',
