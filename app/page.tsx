    ...
    <>
      ...
      <main id="main" tabIndex={-1}>
        ...
        <div className="shell">
          ...
          <section id="contact" className="cta" aria-labelledby="contact-heading"><p className="section-kicker">Say hello</p><h2 id="contact-heading">If you’ve got an inelegant problem, I’m interested.</h2><p>I’m looking for work where AI, product thinking, communication, and practical building all belong in the same room.</p><div className="buttons"><a className="button primary" href={`mailto:${site.email}`}>Email me</a><ExternalLink className="button secondary" href={site.githubUrl}>GitHub</ExternalLink></div></section>
        </div>
      </main>
